...
class TeamMatchesLiveView extends StatefulWidget  {
  final String matchId;
  final String team1id, team2id;
  const TeamMatchesLiveView(this.matchId, this.team1id, this.team2id, {super.key});

  @override
  State<TeamMatchesLiveView> createState() => _TeamMatchesLiveViewState();
}

class _TeamMatchesLiveViewState extends State<TeamMatchesLiveView> with SingleTickerProviderStateMixin{
