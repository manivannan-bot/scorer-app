...
import '../teamsdetailsview/team_matches_live_view.dart';
    ...
    return GestureDetector(onTap: (){
      Navigator.push(context,
          MaterialPageRoute(builder:
              (context)=>
                  TeamMatchesLiveView(widget.teams!.matchId!.toString(),widget.teams!.team1Id!.toString(),widget.teams!.team2Id!.toString())));
    },
      child: Padding(
