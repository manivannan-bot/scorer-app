...
class RetiredScreens extends StatefulWidget {
  ...
  const RetiredScreens({required this.ballType,required this.scoringData, required this.refresh, super.key});
                      ...
                      children: [
                        Padding(
                          ...
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text("Can batter can bat again with existing runs? *",style: fontMedium.copyWith(
                                fontSize: 12.sp,
                                color: AppColor.blackColour,
                              ),),
                              SizedBox(height: 1.5.h,),
                              Row(
                                ...
                                children: <Widget>[
                                  ...
                                  Text("Yes",style: fontRegular.copyWith(
                                    fontSize: 12.sp,
                                    color: AppColor.blackColour,
                                  ),),
                                  Radio(
                                  ...
                                  Text("No",style: fontRegular.copyWith(
                                    fontSize: 12.sp,
                                    color: AppColor.blackColour,
                                  ),),
                                ],
                        ...
                        Container(
                          ...
                          child: Row(
                            children: <Widget>[
                              Theme(
                                data: ThemeData(
                                  unselectedWidgetColor: const Color(0xffFBC041), // Change color here
                                ),
                                child: Checkbox(
                                  value: isChecked,
                                  onChanged: ( value) {
                                  ...
                                  activeColor: const Color(0xffE8A514),// Change active color to yellow
