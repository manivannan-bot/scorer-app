                  ...
                  onTap: (){
                    ...
                    if (data['label'] == 'Bowled'){
                      showDialog(
                        ...
                        builder: (BuildContext context) {
                          return OutMethodDialog(label: 'Bowled', id: data['id'], scoringData: widget.scoringData!, refresh: widget.refresh);
                        },
                      );
                    }
                    if (data['label'] == 'LBW'){
                      showDialog(
                        context: context,
                        builder: (BuildContext context) {
                          return OutMethodDialog(label: 'LBW',id: data['id'],scoringData: widget.scoringData!, refresh: widget.refresh);
                        },
                      );
                    }
                    if (data['label'] == 'Caught Behind'){
                      showDialog(
                        context: context,
                        builder: (BuildContext context) {
                          return OutMethodDialog(label: 'Caught Behind',id: data['id'],scoringData: widget.scoringData!, refresh: widget.refresh);
                        },
                      );
                    }
                    if (data['label'] == 'Caught & Bowled'){
                      showDialog(
                        context: context,
                        builder: (BuildContext context) {
                          return OutMethodDialog(label: 'Caught & Bowled',id: data['id'],scoringData: widget.scoringData!, refresh: widget.refresh);
                        },
                      );
                    }
                    if (data['label'] == 'Run out (Mankaded)'){
                      showDialog(
                        context: context,
                        builder: (BuildContext context) {
                          return OutMethodDialog(label: 'Mankaded',id: data['id'],scoringData: widget.scoringData!, refresh: widget.refresh);
                        },
                      );
                    }
                    if (data['label'] == 'Hit Wicket'){
                      showDialog(
                        context: context,
                        builder: (BuildContext context) {
                          return OutMethodDialog(label: 'Hit Wicket',id: data['id'],scoringData: widget.scoringData!, refresh: widget.refresh);
                        },
                      );
                    }
                    if (data['label'] == 'Handling the Ball'){
                      showDialog(
                        context: context,
                        builder: (BuildContext context) {
                          return OutMethodDialog(label: 'Handling the Ball',id: data['id'],scoringData: widget.scoringData!, refresh: widget.refresh);
                        },
                      );
                    }
                    if (data['label'] == 'Hit the Ball Twice'){
                      showDialog(
                        context: context,
                        builder: (BuildContext context) {
                          return OutMethodDialog(label: 'Hit the Ball Twice',id: data['id'],scoringData: widget.scoringData!, refresh: widget.refresh);
                        },
                      );
                    }
                    ...
                    if (data['label'] == 'Caught'){
                      Navigator.push(context, MaterialPageRoute(builder: (context) => CaughtOutScreen(ballType:data['id'],scoringData: widget.scoringData!)));
                    }
                    ...
                    if (data['label'] == 'Stumped'){
                      Navigator.push(context, MaterialPageRoute(builder: (context) => RetiredHurtScreen(label: 'Stumped', checkcount: "Wide Ball?",ballType:data['id'],scoringData: widget.scoringData!,)));
                    }
