            ...
            itemBuilder: (context, index) {
              return Container(
                ...
                child: Padding(
                  ...
                  child: Container(
                    width:
                        4, // Adjust the width and height of the circle as needed
                    height: 4,
                    decoration: BoxDecoration(
                    ...
                    child: Center(
                      child: GestureDetector(
                        onTap: () {
                          ...
                          // Navigator.push(
                          //   context,
                          //   MaterialPageRoute(builder: (context) =>GroundCircle()),
                          // );
                        ...
                        child: Text(
                          ...
                          style: TextStyle(
                            color: Colors
                                .black, // Text color as per your requirement
                            fontSize: 24,
                          ),
                        ),
                      ),
...
Future<void> _displayBottomSheet1(BuildContext context) async {
...
void _displayBottomSheet(BuildContext context) {
  ...
  showModalBottomSheet(
    ...
    builder: (BuildContext context) {
      return SizedBox(child: ScoreBottomSheet(),
        height: sheetHeight,
